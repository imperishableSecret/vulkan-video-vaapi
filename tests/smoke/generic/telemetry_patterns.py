...
def main() -> int:
    ...
    for event in (
        ...
        '"bootstrap-placeholder-upgraded"',
        '"bootstrap-export-destroyed-unused"',
        '"bootstrap-placeholder-destroyed-unused"',
        '"bootstrap-export-unavailable"',
        '"invalid-bootstrap-used-as-seed"',
        '"predecode-target-export-refused"',
        '"invalid-active-predecode-placeholder"',
        ...
        '"stream-seed-update"',
        '"stream-seed-invalidated"',
        '"invalid-readable-fd-marked-unsampled"',
        '"invalid-observable-fd-stale"',
        '"invalid-private-shadow-only-for-observable-fd"',
    ...
    for field in (
        ...
        "bootstrap-returned",
        "bootstrap-upgraded",
        "bootstrap-destroyed-unused",
        "sampleable-decoded-exit",
        "sampleable-seed-exit",
        "sampleable-failed-no-valid-pixels",
        "predecode-target-failed-no-valid-seed",
        "predecode-target-needs-proven-seed",
        "active-predecode-placeholder-after-visible",
        ...
        "candidate_pixel_source=",
        "candidate_pixel_identity_valid=",
        "candidate_pixel_content_valid=",
        "candidate_pixel_color_state=",
        "candidate_pixel_proof_state=",
        "candidate_valid=",
        "reject_reason=",
        "content-invalid",
        "nonzero",
        ...
        "target_content_preserved=",
        "source_fd_matches_present=",
        "seed_generation_basis=source-present",
        ...
        "stream_visible_generation=",
        "bootstrap_placeholder_allowed=",
        "active_predecode_domain=",
        "reason=first-decode",
        "reason=surface-destroy",
        "reason=export-seed-candidate",
        "reason=stream-seed-update",
        "source_shadow_gen=",
        ...
        "session_generation=",
        "pixel_crc=",
        "pixel_identity_valid=",
        "pixel_content_valid=",
        "source_safe=",
        "valid=",
        "reason=source-detached",
        "returned_fd=1 fd_observable=0",
        "fd_observable=1 action=",
        "final_event=",
        "ctx_stream=",
        "ctx_codec=",
    ):
