...
def main() -> int:
    ...
    totals = data["totals"]
    check(data["trace_records"] == 74, "trace record count mismatch")
    ...
    check(
        "export_role=sampleable-presentation" in FIXTURE and "decision=fail reason=no-valid-decoded-or-seed-pixels returned_fd=0" in FIXTURE,
