...
VAStatus vkvv_vulkan_decode_h264(void* runtime, void* session, VkvvDriver* drv, VkvvContext* vctx, VkvvSurface* target, VAProfile profile, const VkvvH264DecodeInput* input,
