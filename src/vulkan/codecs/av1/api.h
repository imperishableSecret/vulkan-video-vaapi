...
VAStatus vkvv_vulkan_configure_av1_session(void* runtime, void* session, const VkvvSurface* target, const VkvvAV1DecodeInput* input, char* reason, size_t reason_size);
