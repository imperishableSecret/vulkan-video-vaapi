...
bool     vkvv_vulkan_surface_has_pending_displayable_work(void* runtime, const VkvvSurface* surface);
VAStatus vkvv_vulkan_prepare_surface_export(void* runtime, VkvvSurface* surface, char* reason, size_t reason_size);
VAStatus vkvv_vulkan_refresh_surface_export(void* runtime, VkvvSurface* surface, bool displayable, char* reason, size_t reason_size);
