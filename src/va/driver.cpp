...
static VAStatus              vkvvDriverInit(VADriverContextP ctx) {
    ...
    if (drv->caps.h264 || drv->caps.vp9 || drv->caps.vp9_10 || drv->caps.vp9_12 || drv->caps.av1 || drv->caps.av1_10) {
        char reason[512] = {};
...
extern "C" __attribute__((visibility("default"))) VAStatus __vaDriverInit_1_0(VADriverContextP ctx) {
    try {
